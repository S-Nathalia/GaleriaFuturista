...
def desenhar_sala(VAO, textura, indice, posicao, model_loc, GL):
...
def criar():
    ...
    mulher_pos = pyrr.matrix44.create_from_translation(pyrr.Vector3([0, 2, -13]))
    ...
    banco_pos = pyrr.matrix44.create_from_translation(pyrr.Vector3([0, 1, -15]))
